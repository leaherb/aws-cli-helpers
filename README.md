...
The purpose of this repository is to build-up a store of scripts and templates to help launch, report and manage CloudFormation resources. Also, curate a list of helper **Resources** in this README.
